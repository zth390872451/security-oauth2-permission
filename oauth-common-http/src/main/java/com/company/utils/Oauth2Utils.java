...
public class Oauth2Utils {
    ...
    static {
        ...
        getAuthUrl  = ApplicationSupport.getParamVal("oauth.getAuth");
    }
    ...
    public static OAuth2Authentication getAuthenticationInOauth2Client(String tokenValue){
        ...
        try {
            ...
            OAuth2Authentication oAuth2Authentication = restTemplate.getForObject(getAuthUrl+"?token="+tokenValue, OAuth2Authentication.class);
            return oAuth2Authentication;
        }catch (Exception e){
     ...
     * @return
     */
    public static Object getAuthenticationInOauth2Client2(String tokenValue){
        if (StringUtils.isEmpty(tokenValue)) {
            return null;
        }
        try {
            RestTemplate restTemplate = new RestTemplate();
            Object oAuth2Authentication = restTemplate.getForObject(getAuthUrl+"?token="+tokenValue, Object.class);
